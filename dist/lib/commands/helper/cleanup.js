                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(((_b = msg.guild) === null || _b === void 0 ? void 0 : _b.members.cache.map(function (m) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, Promise.all(m.roles.cache.map(function (r) { return __awaiter(_this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            if (!testExpr.test(r.name)) return [3 /*break*/, 2];
                                                            return [4 /*yield*/, m.roles.remove(r)];
