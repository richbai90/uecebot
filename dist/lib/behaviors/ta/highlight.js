...
var getTAs_1 = require("../../utils/ta/getTAs");
function highlightTAContent(message, bot) {
    return __awaiter(this, void 0, void 0, function () {
        var emoji, TAs, lastM, lastE;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (lastM.size < 2)
                        return [2 /*return*/];
                    return [4 /*yield*/, lastM.first(2)[1].fetch(true)];
                case 3:
                    lastM = _a.sent();
                    if (lastM.author.id === message.author.id) {
                        lastE = lastM.reactions.cache.get(emoji);
                        if (lastE)
                            lastE.remove();
                    }
                    message.react(emoji);
...
exports.default = highlightTAContent;
